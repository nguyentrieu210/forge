...
assert.equal(contract.status, "SYNTHETIC_PARALLEL_PASS");
...
assert.equal(contract.execution_evidence.days_reconciled, 3);
assert.equal(contract.execution_evidence.all_axis_variances_zero, true);
