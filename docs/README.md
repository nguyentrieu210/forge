...
6. `RUNBOOK.md` và `DELIVERY_POLICY.md` — ranh giới vận hành/merge/deploy.
...
## 3. Architecture / product contracts
...
## 4. Canonical historical evidence
...
## 5. Files không nên sống lâu trên `main`
