...
Status: **RUNNING — independent exact-head replay active; blockers recorded; no maturity promotion**
...
| A4 finance/VN statutory | #602 | `84f25a829bb7eb28ab8bce053dc336435b46e77f` | focused Node evidence absent at audit time; replay |
| A5 HCM/VN payroll | #604 | `1baaf38d92f5aa0d53cfd2260d5baade850be8dd` | worker explicitly says executable suite NOT RUN; replay |
| A6 UI/mobile/PWA | #598 | `007572266465b9fb4944929f382162166740884b` | worker browser execution absent; run Chromium matrix |
| A7 App Factory | #606 | `e656c19d54450f1290ad44e8bba8819e650b42ef` | backend/schema candidate; replay approval/OCC/SoD/idempotency |
| A11 procurement/P2P | #600 | `27c616c2a77f08bb0284a0de4ea141637ce82462` | worker head moved after first A19 pin; repinned |
| A13 manufacturing/QMS | #603 | `5c9c47ba4e5092fd83c4752785047ad7e69be34c` | worker workflow FAIL; reject release-green claim |
| A15 BI/semantic/AI | #608 | `3c6db92969d80aab92afdc9ef4f07db0cbe2565b` | authored tests NOT RUN; replay permission/data-boundary suite |
| A17 logistics/POS/commerce | #601 | `f2504064dbdf929ba6c03107eea624463943fce1` | default workflows skipped; replay route permissions |
| A18 Alumdoor vertical | #611 | `b3e428d21b4be13337694fde9a78d77b37c8db93` | isolated 12/12 claimed; replay exact source tests |
...
A1/A3 have focused exact-head PASS. A4/A17 lacked accepted focused execution at audit time. A5/A15 explicitly report tests as NOT RUN. A6 lacked browser execution. A18 has isolated test evidence but no full repository execution. A19 therefore replays instead of inheriting prose.
