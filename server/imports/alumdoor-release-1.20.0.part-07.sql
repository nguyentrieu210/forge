-- Alumdoor 1.20.0: full compiler-normalized metadata release.
...
SELECT
  ...
  'admin','2026-07-29T05:15:00.000Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND version IN ('1.19.0', '1.19.1', '1.20.0')
      AND content_hash<>'9473e585fe84956739478ebd1e215edaf9001068bf7ee2a6bd58a66e790c596d'
  )
...
SELECT 'alu','Company','ALUMDOOR',0,
       '{"label":"ALUMDOOR — Cửa cuốn công nghệ Đức/Úc","abbr":"AD","default_currency":"VND","default_inventory_account":"Hàng tồn kho","default_cogs_account":"Giá vốn hàng bán"}','2026-07-29T05:15:00.000Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND version IN ('1.19.0', '1.19.1', '1.20.0')
...
SELECT 'alu','Currency','VND',0,
       '{"currency_scale":0}','2026-07-29T05:15:00.000Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND version IN ('1.19.0', '1.19.1', '1.20.0')
...
SELECT 'alu','UOM','Cái',0,
       '{"uom_name":"Cái","must_be_whole_number":true}','2026-07-29T05:15:00.000Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND version IN ('1.19.0', '1.19.1', '1.20.0')
...
INSERT INTO master_records(tenant_id,record_type,name,disabled,data_json,modified_at)
SELECT 'alu','UOM','Bộ',0,
       '{"uom_name":"Bộ","must_be_whole_number":true}','2026-07-29T05:15:00.000Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND version IN ('1.19.0', '1.19.1', '1.20.0')
...
INSERT INTO master_records(tenant_id,record_type,name,disabled,data_json,modified_at)
SELECT 'alu','UOM','Kg',0,
       '{"uom_name":"Kg"}','2026-07-29T05:15:00.000Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND version IN ('1.19.0', '1.19.1', '1.20.0')
...
SELECT 'alu','UOM','Mét',0,
       '{"uom_name":"Mét"}','2026-07-29T05:15:00.000Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND version IN ('1.19.0', '1.19.1', '1.20.0')
...
INSERT INTO master_records(tenant_id,record_type,name,disabled,data_json,modified_at)
SELECT 'alu','UOM','m2',0,
       '{"uom_name":"m2"}','2026-07-29T05:15:00.000Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND version IN ('1.19.0', '1.19.1', '1.20.0')
...
SELECT 'alu','UOM','Cây',0,
       '{"uom_name":"Cây","must_be_whole_number":true}','2026-07-29T05:15:00.000Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND version IN ('1.19.0', '1.19.1', '1.20.0')
...
SELECT 'alu','UOM','Thanh',0,
       '{"uom_name":"Thanh","must_be_whole_number":true}','2026-07-29T05:15:00.000Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND version IN ('1.19.0', '1.19.1', '1.20.0')
...
SELECT 'alu','UOM','Sợi',0,
       '{"uom_name":"Sợi","must_be_whole_number":true}','2026-07-29T05:15:00.000Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND version IN ('1.19.0', '1.19.1', '1.20.0')
...
SELECT 'alu','UOM','Cuộn',0,
       '{"uom_name":"Cuộn","must_be_whole_number":true}','2026-07-29T05:15:00.000Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND version IN ('1.19.0', '1.19.1', '1.20.0')
...
SELECT 'alu','UOM','Tấm',0,
       '{"uom_name":"Tấm","must_be_whole_number":true}','2026-07-29T05:15:00.000Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND version IN ('1.19.0', '1.19.1', '1.20.0')
...
SELECT 'alu','UOM','Túi',0,
       '{"uom_name":"Túi","must_be_whole_number":true}','2026-07-29T05:15:00.000Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND version IN ('1.19.0', '1.19.1', '1.20.0')
...
SELECT 'alu','UOM','Hộp',0,
       '{"uom_name":"Hộp","must_be_whole_number":true}','2026-07-29T05:15:00.000Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND version IN ('1.19.0', '1.19.1', '1.20.0')
...
SELECT 'alu','UOM','Bình',0,
       '{"uom_name":"Bình","must_be_whole_number":true}','2026-07-29T05:15:00.000Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND version IN ('1.19.0', '1.19.1', '1.20.0')
...
SELECT 'alu','UOM','Lít',0,
       '{"uom_name":"Lít"}','2026-07-29T05:15:00.000Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND version IN ('1.19.0', '1.19.1', '1.20.0')
...
SELECT 'alu','Item Group','Tất cả mặt hàng',0,
       '{"item_group_name":"Tất cả mặt hàng","is_group":true}','2026-07-29T05:15:00.000Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND version IN ('1.19.0', '1.19.1', '1.20.0')
...
SELECT 'alu','Item Group','Thành phẩm',0,
       '{"item_group_name":"Thành phẩm","parent_item_group":"Tất cả mặt hàng","is_group":true}','2026-07-29T05:15:00.000Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND version IN ('1.19.0', '1.19.1', '1.20.0')
...
SELECT 'alu','Item Group','Nguyên vật liệu',0,
       '{"item_group_name":"Nguyên vật liệu","parent_item_group":"Tất cả mặt hàng","is_group":true}','2026-07-29T05:15:00.000Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND version IN ('1.19.0', '1.19.1', '1.20.0')
...
SELECT 'alu','Item Group','Linh kiện & thiết bị',0,
       '{"item_group_name":"Linh kiện & thiết bị","parent_item_group":"Tất cả mặt hàng","is_group":true}','2026-07-29T05:15:00.000Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND version IN ('1.19.0', '1.19.1', '1.20.0')
...
SELECT 'alu','Item Group','Dịch vụ',0,
       '{"item_group_name":"Dịch vụ","parent_item_group":"Tất cả mặt hàng"}','2026-07-29T05:15:00.000Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND version IN ('1.19.0', '1.19.1', '1.20.0')
...
SELECT 'alu','Item Group','Cửa cuốn',0,
       '{"item_group_name":"Cửa cuốn","parent_item_group":"Thành phẩm"}','2026-07-29T05:15:00.000Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND version IN ('1.19.0', '1.19.1', '1.20.0')
...
SELECT 'alu','Item Group','Cửa nhôm kính',0,
       '{"item_group_name":"Cửa nhôm kính","parent_item_group":"Thành phẩm"}','2026-07-29T05:15:00.000Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND version IN ('1.19.0', '1.19.1', '1.20.0')
...
SELECT 'alu','Item Group','Nan/lá cửa',0,
       '{"item_group_name":"Nan/lá cửa","parent_item_group":"Nguyên vật liệu"}','2026-07-29T05:15:00.000Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND version IN ('1.19.0', '1.19.1', '1.20.0')
...
SELECT 'alu','Item Group','Mô tơ',0,
       '{"item_group_name":"Mô tơ","parent_item_group":"Linh kiện & thiết bị"}','2026-07-29T05:15:00.000Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND version IN ('1.19.0', '1.19.1', '1.20.0')
...
SELECT 'alu','Item Group','Ray và trục',0,
       '{"item_group_name":"Ray và trục","parent_item_group":"Nguyên vật liệu"}','2026-07-29T05:15:00.000Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND version IN ('1.19.0', '1.19.1', '1.20.0')
...
SELECT 'alu','Item Group','Phụ kiện',0,
       '{"item_group_name":"Phụ kiện","parent_item_group":"Linh kiện & thiết bị"}','2026-07-29T05:15:00.000Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND version IN ('1.19.0', '1.19.1', '1.20.0')
...
SELECT 'alu','Item Group','Remote và điều khiển',0,
       '{"item_group_name":"Remote và điều khiển","parent_item_group":"Linh kiện & thiết bị"}','2026-07-29T05:15:00.000Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND version IN ('1.19.0', '1.19.1', '1.20.0')
...
SELECT 'alu','Item Group','Bộ lưu điện',0,
       '{"item_group_name":"Bộ lưu điện","parent_item_group":"Linh kiện & thiết bị"}','2026-07-29T05:15:00.000Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND version IN ('1.19.0', '1.19.1', '1.20.0')
...
SELECT 'alu','Warehouse','Kho Alumdoor',0,
       '{"warehouse_name":"Kho Alumdoor","is_group":true,"disabled":false}','2026-07-29T05:15:00.000Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND version IN ('1.19.0', '1.19.1', '1.20.0')
...
SELECT 'alu','Warehouse','K36',0,
       '{"warehouse_name":"K36","parent_warehouse":"Kho Alumdoor","is_group":false,"address":"Kho vật lý K36","disabled":false}','2026-07-29T05:15:00.000Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND version IN ('1.19.0', '1.19.1', '1.20.0')
...
SELECT 'alu','Warehouse','K12',0,
       '{"warehouse_name":"K12","parent_warehouse":"Kho Alumdoor","is_group":false,"address":"Kho vật lý K12","disabled":false}','2026-07-29T05:15:00.000Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND version IN ('1.19.0', '1.19.1', '1.20.0')
...
SELECT 'alu','Measurement Profile','Hàng thường',0,
       '{"profile_name":"Hàng thường","inventory_mode":"Hàng thường","stock_uom":"Cái"}','2026-07-29T05:15:00.000Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND version IN ('1.19.0', '1.19.1', '1.20.0')
...
SELECT 'alu','Measurement Profile','Nhôm cây/lá',0,
       '{"profile_name":"Nhôm cây/lá","inventory_mode":"Nhôm cây/lá","stock_uom":"Kg","track_dimension_lot":true,"require_color":true,"require_length":true,"require_piece_qty":true}','2026-07-29T05:15:00.000Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND version IN ('1.19.0', '1.19.1', '1.20.0')
...
SELECT 'alu','Measurement Profile','Tấm/Kính',0,
       '{"profile_name":"Tấm/Kính","inventory_mode":"Tấm/Kính","stock_uom":"Tấm","track_dimension_lot":true,"require_length":true,"require_width":true,"require_piece_qty":true}','2026-07-29T05:15:00.000Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND version IN ('1.19.0', '1.19.1', '1.20.0')
...
SELECT 'alu','Measurement Profile','Cuộn',0,
       '{"profile_name":"Cuộn","inventory_mode":"Cuộn","stock_uom":"Kg","track_dimension_lot":true,"require_width":true}','2026-07-29T05:15:00.000Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND version IN ('1.19.0', '1.19.1', '1.20.0')
...
SELECT 'alu','Measurement Profile','Lô/Serial',0,
       '{"profile_name":"Lô/Serial","inventory_mode":"Lô/Serial","stock_uom":"Cái"}','2026-07-29T05:15:00.000Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND version IN ('1.19.0', '1.19.1', '1.20.0')
...
SELECT 'alu','Measurement Profile','Thành phẩm theo m2',0,
       '{"profile_name":"Thành phẩm theo m2","inventory_mode":"Thành phẩm theo m2","stock_uom":"Bộ","require_color":true,"require_length":true,"require_width":true}','2026-07-29T05:15:00.000Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND version IN ('1.19.0', '1.19.1', '1.20.0')
...
SELECT 'alu','Account','Phải thu khách hàng',0,
       '{"account_type":"Receivable"}','2026-07-29T05:15:00.000Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND version IN ('1.19.0', '1.19.1', '1.20.0')
...
SELECT 'alu','Account','Doanh thu bán hàng',0,
       '{"account_type":"Income"}','2026-07-29T05:15:00.000Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND version IN ('1.19.0', '1.19.1', '1.20.0')
...
SELECT 'alu','Account','Giá vốn hàng bán',0,
       '{"account_type":"Expense"}','2026-07-29T05:15:00.000Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND version IN ('1.19.0', '1.19.1', '1.20.0')
...
SELECT 'alu','Account','Hàng tồn kho',0,
       '{"account_type":"Asset"}','2026-07-29T05:15:00.000Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND version IN ('1.19.0', '1.19.1', '1.20.0')
...
SELECT 'alu','Account','Phải trả người bán',0,
       '{"account_type":"Payable"}','2026-07-29T05:15:00.000Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND version IN ('1.19.0', '1.19.1', '1.20.0')
...
SELECT 'alu','Account','Hàng nhận chưa có hoá đơn',0,
       '{"account_type":"Liability"}','2026-07-29T05:15:00.000Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND version IN ('1.19.0', '1.19.1', '1.20.0')
...
INSERT INTO app_objects(tenant_id,app_id,object_type,object_name,object_scope)
SELECT column1,column2,column3,column4,column5
FROM (VALUES ('alu','alumdoor','DocType','Price List',''),('alu','alumdoor','DocType','Item Price',''),('alu','alumdoor','DocType','Pricing Rule',''),('alu','alumdoor','DocType','Quotation Item',''),('alu','alumdoor','DocType','Quotation',''),('alu','alumdoor','DocType','Sales Order Item',''),('alu','alumdoor','DocType','Sales Order',''),('alu','alumdoor','DocType','Delivery Note Item',''),('alu','alumdoor','DocType','Delivery Note',''),('alu','alumdoor','DocType','Aluminium Lot',''),('alu','alumdoor','DocType','Aluminium Cut',''),('alu','alumdoor','DocType','Stock Entry Item',''),('alu','alumdoor','DocType','Stock Entry',''),('alu','alumdoor','DocType','Sales Invoice Item',''),('alu','alumdoor','DocType','Sales Invoice',''),('alu','alumdoor','DocType','Payment Entry',''),('alu','alumdoor','DocType','BOM Item',''),('alu','alumdoor','DocType','Supplier',''),('alu','alumdoor','DocType','Material Request Item',''),('alu','alumdoor','DocType','Material Request',''))
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND version IN ('1.19.0', '1.19.1', '1.20.0')
...
INSERT INTO app_objects(tenant_id,app_id,object_type,object_name,object_scope)
SELECT column1,column2,column3,column4,column5
FROM (VALUES ('alu','alumdoor','DocType','RFQ Supplier',''),('alu','alumdoor','DocType','Request for Quotation',''),('alu','alumdoor','DocType','Supplier Quotation Item',''),('alu','alumdoor','DocType','Supplier Quotation',''),('alu','alumdoor','DocType','Purchase Order Item',''),('alu','alumdoor','DocType','Purchase Order',''),('alu','alumdoor','DocType','Purchase Receipt Item',''),('alu','alumdoor','DocType','Purchase Receipt',''),('alu','alumdoor','DocType','Purchase Invoice Item',''),('alu','alumdoor','DocType','Purchase Invoice',''),('alu','alumdoor','DocType','Stock Return Item',''),('alu','alumdoor','DocType','Stock Return',''),('alu','alumdoor','DocType','Debit Note Item',''),('alu','alumdoor','DocType','Debit Note',''),('alu','alumdoor','DocType','Bill of Materials',''),('alu','alumdoor','DocType','Work Order',''),('alu','alumdoor','DocType','Legacy Sales Order Item',''),('alu','alumdoor','DocType','Legacy Sales Order',''),('alu','alumdoor','DocType','Legacy Goods Intake',''),('alu','alumdoor','DocType','Warranty Claim',''))
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND version IN ('1.19.0', '1.19.1', '1.20.0')
...
INSERT INTO app_objects(tenant_id,app_id,object_type,object_name,object_scope)
SELECT column1,column2,column3,column4,column5
FROM (VALUES ('alu','alumdoor','DocType','Production Standard',''),('alu','alumdoor','Workflow','Chốt báo giá',''),('alu','alumdoor','Print Format','Hoá đơn ALUMDOOR',''),('alu','alumdoor','Print Format','Phiếu sản xuất',''),('alu','alumdoor','Print Format','Báo giá ALUMDOOR',''),('alu','alumdoor','Print Format','Đơn mua hàng ALUMDOOR',''),('alu','alumdoor','Print Format','Phiếu nhập kho ALUMDOOR',''),('alu','alumdoor','Print Format','Yêu cầu báo giá ALUMDOOR',''),('alu','alumdoor','Role','Chủ xưởng',''),('alu','alumdoor','Role','Kinh doanh',''),('alu','alumdoor','Role','Thủ kho',''),('alu','alumdoor','Role','Kế toán',''),('alu','alumdoor','Role','Sản xuất',''),('alu','alumdoor','Master Record','ALUMDOOR','Company'),('alu','alumdoor','Master Record','VND','Currency'),('alu','alumdoor','Master Record','Cái','UOM'),('alu','alumdoor','Master Record','Bộ','UOM'),('alu','alumdoor','Master Record','Kg','UOM'),('alu','alumdoor','Master Record','Mét','UOM'),('alu','alumdoor','Master Record','m2','UOM'))
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND version IN ('1.19.0', '1.19.1', '1.20.0')
...
INSERT INTO app_objects(tenant_id,app_id,object_type,object_name,object_scope)
SELECT column1,column2,column3,column4,column5
FROM (VALUES ('alu','alumdoor','Master Record','Remote và điều khiển','Item Group'),('alu','alumdoor','Master Record','Bộ lưu điện','Item Group'),('alu','alumdoor','Master Record','Kho Alumdoor','Warehouse'),('alu','alumdoor','Master Record','K36','Warehouse'),('alu','alumdoor','Master Record','K12','Warehouse'),('alu','alumdoor','Master Record','Hàng thường','Measurement Profile'),('alu','alumdoor','Master Record','Nhôm cây/lá','Measurement Profile'),('alu','alumdoor','Master Record','Tấm/Kính','Measurement Profile'),('alu','alumdoor','Master Record','Cuộn','Measurement Profile'),('alu','alumdoor','Master Record','Lô/Serial','Measurement Profile'),('alu','alumdoor','Master Record','Thành phẩm theo m2','Measurement Profile'),('alu','alumdoor','Master Record','Phải thu khách hàng','Account'),('alu','alumdoor','Master Record','Doanh thu bán hàng','Account'),('alu','alumdoor','Master Record','Giá vốn hàng bán','Account'),('alu','alumdoor','Master Record','Hàng tồn kho','Account'),('alu','alumdoor','Master Record','Tiền mặt','Account'),('alu','alumdoor','Master Record','Tiền gửi ngân hàng','Account'),('alu','alumdoor','Master Record','Chênh lệch làm tròn','Account'),('alu','alumdoor','Master Record','Phải trả người bán','Account'),('alu','alumdoor','Master Record','Hàng nhận chưa có hoá đơn','Account'))
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND version IN ('1.19.0', '1.19.1', '1.20.0')
...
SET manifest_json=json_set(manifest_json,'$.doctypes',json('[]')),
    modified_at='2026-07-29T05:15:00.000Z'
WHERE tenant_id='alu' AND app_id='alumdoor'
  AND version IN ('1.19.0','1.19.1','1.20.0')
  AND content_hash<>'9473e585fe84956739478ebd1e215edaf9001068bf7ee2a6bd58a66e790c596d';
