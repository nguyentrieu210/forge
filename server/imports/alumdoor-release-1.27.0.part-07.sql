-- Alumdoor 1.27.0: full compiler-normalized metadata release.
...
SELECT
  ...
  0,'admin','2026-07-29T13:57:38.668Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'6da6fa8c5877c3613d012e2674c3b8d3d807dc7ca9fbddb2883ccd5b892c1357'
  )
...
SELECT
  ...
  'admin','2026-07-29T13:57:38.668Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'6da6fa8c5877c3613d012e2674c3b8d3d807dc7ca9fbddb2883ccd5b892c1357'
...
SELECT 'alu','Company','ALUMDOOR',0,
       '{"label":"ALUMDOOR — Cửa cuốn công nghệ Đức/Úc","abbr":"AD","default_currency":"VND","default_inventory_account":"Hàng tồn kho","default_cogs_account":"Giá vốn hàng bán"}','2026-07-29T13:57:38.668Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'6da6fa8c5877c3613d012e2674c3b8d3d807dc7ca9fbddb2883ccd5b892c1357'
...
SELECT 'alu','Currency','VND',0,
       '{"currency_scale":0}','2026-07-29T13:57:38.668Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'6da6fa8c5877c3613d012e2674c3b8d3d807dc7ca9fbddb2883ccd5b892c1357'
...
SELECT 'alu','UOM','Cái',0,
       '{"uom_name":"Cái","must_be_whole_number":true}','2026-07-29T13:57:38.668Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'6da6fa8c5877c3613d012e2674c3b8d3d807dc7ca9fbddb2883ccd5b892c1357'
...
INSERT INTO master_records(tenant_id,record_type,name,disabled,data_json,modified_at)
SELECT 'alu','UOM','Bộ',0,
       '{"uom_name":"Bộ","must_be_whole_number":true}','2026-07-29T13:57:38.668Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'6da6fa8c5877c3613d012e2674c3b8d3d807dc7ca9fbddb2883ccd5b892c1357'
...
INSERT INTO master_records(tenant_id,record_type,name,disabled,data_json,modified_at)
SELECT 'alu','UOM','Kg',0,
       '{"uom_name":"Kg"}','2026-07-29T13:57:38.668Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'6da6fa8c5877c3613d012e2674c3b8d3d807dc7ca9fbddb2883ccd5b892c1357'
...
SELECT 'alu','UOM','Mét',0,
       '{"uom_name":"Mét"}','2026-07-29T13:57:38.668Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'6da6fa8c5877c3613d012e2674c3b8d3d807dc7ca9fbddb2883ccd5b892c1357'
...
INSERT INTO master_records(tenant_id,record_type,name,disabled,data_json,modified_at)
SELECT 'alu','UOM','m2',0,
       '{"uom_name":"m2"}','2026-07-29T13:57:38.668Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'6da6fa8c5877c3613d012e2674c3b8d3d807dc7ca9fbddb2883ccd5b892c1357'
...
SELECT 'alu','UOM','Cây',0,
       '{"uom_name":"Cây","must_be_whole_number":true}','2026-07-29T13:57:38.668Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'6da6fa8c5877c3613d012e2674c3b8d3d807dc7ca9fbddb2883ccd5b892c1357'
...
SELECT 'alu','UOM','Thanh',0,
       '{"uom_name":"Thanh","must_be_whole_number":true}','2026-07-29T13:57:38.668Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'6da6fa8c5877c3613d012e2674c3b8d3d807dc7ca9fbddb2883ccd5b892c1357'
...
SELECT 'alu','UOM','Sợi',0,
       '{"uom_name":"Sợi","must_be_whole_number":true}','2026-07-29T13:57:38.668Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'6da6fa8c5877c3613d012e2674c3b8d3d807dc7ca9fbddb2883ccd5b892c1357'
...
SELECT 'alu','UOM','Cuộn',0,
       '{"uom_name":"Cuộn","must_be_whole_number":true}','2026-07-29T13:57:38.668Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'6da6fa8c5877c3613d012e2674c3b8d3d807dc7ca9fbddb2883ccd5b892c1357'
...
SELECT 'alu','UOM','Tấm',0,
       '{"uom_name":"Tấm","must_be_whole_number":true}','2026-07-29T13:57:38.668Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'6da6fa8c5877c3613d012e2674c3b8d3d807dc7ca9fbddb2883ccd5b892c1357'
...
SELECT 'alu','UOM','Túi',0,
       '{"uom_name":"Túi","must_be_whole_number":true}','2026-07-29T13:57:38.668Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'6da6fa8c5877c3613d012e2674c3b8d3d807dc7ca9fbddb2883ccd5b892c1357'
...
SELECT 'alu','UOM','Hộp',0,
       '{"uom_name":"Hộp","must_be_whole_number":true}','2026-07-29T13:57:38.668Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'6da6fa8c5877c3613d012e2674c3b8d3d807dc7ca9fbddb2883ccd5b892c1357'
...
SELECT 'alu','UOM','Bình',0,
       '{"uom_name":"Bình","must_be_whole_number":true}','2026-07-29T13:57:38.668Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'6da6fa8c5877c3613d012e2674c3b8d3d807dc7ca9fbddb2883ccd5b892c1357'
...
SELECT 'alu','UOM','Lít',0,
       '{"uom_name":"Lít"}','2026-07-29T13:57:38.668Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'6da6fa8c5877c3613d012e2674c3b8d3d807dc7ca9fbddb2883ccd5b892c1357'
...
SELECT 'alu','Item Group','Tất cả mặt hàng',0,
       '{"item_group_name":"Tất cả mặt hàng","is_group":true}','2026-07-29T13:57:38.668Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'6da6fa8c5877c3613d012e2674c3b8d3d807dc7ca9fbddb2883ccd5b892c1357'
...
SELECT 'alu','Item Group','Thành phẩm',0,
       '{"item_group_name":"Thành phẩm","parent_item_group":"Tất cả mặt hàng","is_group":true}','2026-07-29T13:57:38.668Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'6da6fa8c5877c3613d012e2674c3b8d3d807dc7ca9fbddb2883ccd5b892c1357'
...
SELECT 'alu','Item Group','Nguyên vật liệu',0,
       '{"item_group_name":"Nguyên vật liệu","parent_item_group":"Tất cả mặt hàng","is_group":true}','2026-07-29T13:57:38.668Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'6da6fa8c5877c3613d012e2674c3b8d3d807dc7ca9fbddb2883ccd5b892c1357'
...
SELECT 'alu','Item Group','Linh kiện & thiết bị',0,
       '{"item_group_name":"Linh kiện & thiết bị","parent_item_group":"Tất cả mặt hàng","is_group":true}','2026-07-29T13:57:38.668Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'6da6fa8c5877c3613d012e2674c3b8d3d807dc7ca9fbddb2883ccd5b892c1357'
...
SELECT 'alu','Item Group','Dịch vụ',0,
       '{"item_group_name":"Dịch vụ","parent_item_group":"Tất cả mặt hàng"}','2026-07-29T13:57:38.668Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'6da6fa8c5877c3613d012e2674c3b8d3d807dc7ca9fbddb2883ccd5b892c1357'
...
SELECT 'alu','Item Group','Cửa cuốn',0,
       '{"item_group_name":"Cửa cuốn","parent_item_group":"Thành phẩm"}','2026-07-29T13:57:38.668Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'6da6fa8c5877c3613d012e2674c3b8d3d807dc7ca9fbddb2883ccd5b892c1357'
...
SELECT 'alu','Item Group','Cửa nhôm kính',0,
       '{"item_group_name":"Cửa nhôm kính","parent_item_group":"Thành phẩm"}','2026-07-29T13:57:38.668Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'6da6fa8c5877c3613d012e2674c3b8d3d807dc7ca9fbddb2883ccd5b892c1357'
...
SELECT 'alu','Item Group','Nan/lá cửa',0,
       '{"item_group_name":"Nan/lá cửa","parent_item_group":"Nguyên vật liệu"}','2026-07-29T13:57:38.668Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'6da6fa8c5877c3613d012e2674c3b8d3d807dc7ca9fbddb2883ccd5b892c1357'
...
SELECT 'alu','Item Group','Mô tơ',0,
       '{"item_group_name":"Mô tơ","parent_item_group":"Linh kiện & thiết bị"}','2026-07-29T13:57:38.668Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'6da6fa8c5877c3613d012e2674c3b8d3d807dc7ca9fbddb2883ccd5b892c1357'
...
SELECT 'alu','Item Group','Ray và trục',0,
       '{"item_group_name":"Ray và trục","parent_item_group":"Nguyên vật liệu"}','2026-07-29T13:57:38.668Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'6da6fa8c5877c3613d012e2674c3b8d3d807dc7ca9fbddb2883ccd5b892c1357'
...
SELECT 'alu','Item Group','Phụ kiện',0,
       '{"item_group_name":"Phụ kiện","parent_item_group":"Linh kiện & thiết bị"}','2026-07-29T13:57:38.668Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'6da6fa8c5877c3613d012e2674c3b8d3d807dc7ca9fbddb2883ccd5b892c1357'
...
SELECT 'alu','Item Group','Remote và điều khiển',0,
       '{"item_group_name":"Remote và điều khiển","parent_item_group":"Linh kiện & thiết bị"}','2026-07-29T13:57:38.668Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'6da6fa8c5877c3613d012e2674c3b8d3d807dc7ca9fbddb2883ccd5b892c1357'
...
SELECT 'alu','Item Group','Bộ lưu điện',0,
       '{"item_group_name":"Bộ lưu điện","parent_item_group":"Linh kiện & thiết bị"}','2026-07-29T13:57:38.668Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'6da6fa8c5877c3613d012e2674c3b8d3d807dc7ca9fbddb2883ccd5b892c1357'
...
SELECT 'alu','Warehouse','Kho Alumdoor',0,
       '{"warehouse_name":"Kho Alumdoor","is_group":true,"disabled":false}','2026-07-29T13:57:38.668Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'6da6fa8c5877c3613d012e2674c3b8d3d807dc7ca9fbddb2883ccd5b892c1357'
...
SELECT 'alu','Warehouse','K36',0,
       '{"warehouse_name":"K36","parent_warehouse":"Kho Alumdoor","is_group":false,"address":"Kho vật lý K36","disabled":false}','2026-07-29T13:57:38.668Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'6da6fa8c5877c3613d012e2674c3b8d3d807dc7ca9fbddb2883ccd5b892c1357'
...
SELECT 'alu','Warehouse','K12',0,
       '{"warehouse_name":"K12","parent_warehouse":"Kho Alumdoor","is_group":false,"address":"Kho vật lý K12","disabled":false}','2026-07-29T13:57:38.668Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'6da6fa8c5877c3613d012e2674c3b8d3d807dc7ca9fbddb2883ccd5b892c1357'
...
INSERT INTO master_records(tenant_id,record_type,name,disabled,data_json,modified_at)
SELECT 'alu','Cutting Policy','Cửa Đức — công thức chuẩn',0,
       '{"policy_name":"Cửa Đức — công thức chuẩn","door_type":"Cửa Đức","dealer_width_basis":"Phủ bì nhựa","retail_width_basis":"Phủ bì ray","dealer_cut_deduction_m":0.02,"retail_cut_deduction_m":0.08,"dealer_split_sales_basis":"Phủ bì nhựa","dealer_full_sales_basis":"Phủ bì nhựa","retail_sales_basis":"Phủ bì ray","purchase_formula":"Kg thực tế","note":"Sản xuất: đại lý PB nhựa − 0,02; lẻ PB ray − 0,08. Mua: kg thực tế × đơn giá."}','2026-07-29T13:57:38.668Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'6da6fa8c5877c3613d012e2674c3b8d3d807dc7ca9fbddb2883ccd5b892c1357'
...
INSERT INTO master_records(tenant_id,record_type,name,disabled,data_json,modified_at)
SELECT 'alu','Cutting Policy','Cửa Úc — công thức chuẩn',0,
       '{"policy_name":"Cửa Úc — công thức chuẩn","door_type":"Cửa Úc","dealer_width_basis":"Phủ bì ray","retail_width_basis":"Phủ bì ray","dealer_cut_deduction_m":0.03,"retail_cut_deduction_m":0.03,"dealer_split_sales_basis":"Phủ bì ray","dealer_full_sales_basis":"Phủ bì ray","retail_sales_basis":"Phủ bì ray","purchase_formula":"Barem kg/m2","purchase_height_basis":"Cao phủ bì","purchase_width_basis":"Rộng cắt lá","note":"Rộng cắt = PB ray − 0,03. Mua: barem × Cao PB × Rộng cắt. Bán: Cao PB × PB ray."}','2026-07-29T13:57:38.668Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'6da6fa8c5877c3613d012e2674c3b8d3d807dc7ca9fbddb2883ccd5b892c1357'
...
INSERT INTO master_records(tenant_id,record_type,name,disabled,data_json,modified_at)
SELECT 'alu','Cutting Policy','Cửa Lưới — công thức chuẩn',0,
       '{"policy_name":"Cửa Lưới — công thức chuẩn","door_type":"Cửa Lưới","dealer_width_basis":"Phủ bì ray","retail_width_basis":"Phủ bì ray","dealer_cut_deduction_m":0.03,"retail_cut_deduction_m":0.03,"butterfly_cut_deduction_m":0.035,"dealer_split_sales_basis":"Rộng cắt lá","dealer_full_sales_basis":"Phủ bì ray","retail_sales_basis":"Phủ bì ray","purchase_formula":"Barem kg/m2","purchase_height_basis":"Cao lưới","purchase_width_basis":"Rộng cắt lá","note":"Đại lý tách món chỉ lấy lưới bán theo rộng cắt; trọn bộ và khách lẻ bán theo PB ray. Có bản bướm trừ 0,035."}','2026-07-29T13:57:38.668Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'6da6fa8c5877c3613d012e2674c3b8d3d807dc7ca9fbddb2883ccd5b892c1357'
...
INSERT INTO master_records(tenant_id,record_type,name,disabled,data_json,modified_at)
SELECT 'alu','Cutting Policy','Cửa Đài Loan — công thức chuẩn',0,
       '{"policy_name":"Cửa Đài Loan — công thức chuẩn","door_type":"Cửa Đài Loan","dealer_width_basis":"Phủ bì ray","retail_width_basis":"Phủ bì ray","dealer_cut_deduction_m":0.03,"retail_cut_deduction_m":0.03,"butterfly_cut_deduction_m":0.035,"dealer_split_sales_basis":"Rộng cắt lá","dealer_full_sales_basis":"Phủ bì ray","retail_sales_basis":"Phủ bì ray","manual_pull_sales_basis":"Phủ bì ray","purchase_formula":"Barem kg/m2","purchase_height_basis":"Cao lưới","purchase_width_basis":"Rộng cắt lá","note":"Đại lý tách món bán theo rộng cắt; trọn bộ, kéo tay và khách lẻ bán theo PB ray. Có bản bướm trừ 0,035."}','2026-07-29T13:57:38.668Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'6da6fa8c5877c3613d012e2674c3b8d3d807dc7ca9fbddb2883ccd5b892c1357'
...
INSERT INTO master_records(tenant_id,record_type,name,disabled,data_json,modified_at)
SELECT 'alu','Cutting Policy','Cửa Siêu Trường — công thức chuẩn',0,
       '{"policy_name":"Cửa Siêu Trường — công thức chuẩn","door_type":"Cửa Siêu Trường","dealer_width_basis":"Phủ bì ray","retail_width_basis":"Phủ bì ray","dealer_cut_deduction_m":0.03,"retail_cut_deduction_m":0.03,"butterfly_cut_deduction_m":0.035,"dealer_split_sales_basis":"Rộng cắt lá","dealer_full_sales_basis":"Rộng cắt lá","retail_sales_basis":"Phủ bì ray","purchase_formula":"Barem kg/m2","purchase_height_basis":"Cao lưới","purchase_width_basis":"Rộng cắt lá","note":"Đại lý bán theo rộng cắt; khách lẻ bán theo PB ray. Có bản bướm trừ 0,035."}','2026-07-29T13:57:38.668Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'6da6fa8c5877c3613d012e2674c3b8d3d807dc7ca9fbddb2883ccd5b892c1357'
...
SELECT 'alu','Cutting Policy','Cửa Đức — đại lý',0,
       '{"policy_name":"Cửa Đức — đại lý","door_type":"Cửa Đức","dealer_width_basis":"Phủ bì nhựa","retail_width_basis":"Phủ bì ray","dealer_cut_deduction_m":0.02,"retail_cut_deduction_m":0.08,"dealer_split_sales_basis":"Phủ bì nhựa","dealer_full_sales_basis":"Phủ bì nhựa","retail_sales_basis":"Phủ bì ray","purchase_formula":"Kg thực tế","disabled":true,"note":"Đã gộp vào Cửa Đức — công thức chuẩn từ bản 1.26.0."}','2026-07-29T13:57:38.668Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'6da6fa8c5877c3613d012e2674c3b8d3d807dc7ca9fbddb2883ccd5b892c1357'
...
SELECT 'alu','Cutting Policy','Cửa Đức — khách lẻ',0,
       '{"policy_name":"Cửa Đức — khách lẻ","door_type":"Cửa Đức","dealer_width_basis":"Phủ bì nhựa","retail_width_basis":"Phủ bì ray","dealer_cut_deduction_m":0.02,"retail_cut_deduction_m":0.08,"dealer_split_sales_basis":"Phủ bì nhựa","dealer_full_sales_basis":"Phủ bì nhựa","retail_sales_basis":"Phủ bì ray","purchase_formula":"Kg thực tế","disabled":true,"note":"Đã gộp vào Cửa Đức — công thức chuẩn từ bản 1.26.0."}','2026-07-29T13:57:38.668Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'6da6fa8c5877c3613d012e2674c3b8d3d807dc7ca9fbddb2883ccd5b892c1357'
...
SELECT 'alu','Measurement Profile','Hàng thường',0,
       '{"profile_name":"Hàng thường","inventory_mode":"Hàng thường","stock_uom":"Cái"}','2026-07-29T13:57:38.668Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'6da6fa8c5877c3613d012e2674c3b8d3d807dc7ca9fbddb2883ccd5b892c1357'
...
SELECT 'alu','Measurement Profile','Nhôm cây/lá',0,
       '{"profile_name":"Nhôm cây/lá","inventory_mode":"Nhôm cây/lá","stock_uom":"Kg","track_dimension_lot":true,"require_color":true,"require_length":true,"require_piece_qty":true}','2026-07-29T13:57:38.668Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'6da6fa8c5877c3613d012e2674c3b8d3d807dc7ca9fbddb2883ccd5b892c1357'
