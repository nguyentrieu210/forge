...
SELECT 'alu','Chủ xưởng',1,0,'2026-07-29T13:29:32.534Z'
WHERE EXISTS (
...
INSERT INTO roles(tenant_id,role,desk_access,is_standard,modified_at)
SELECT 'alu','Kinh doanh',1,0,'2026-07-29T13:29:32.534Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'341097adc3432ffac29cddc7ad229ad5bd99cc06bdf71b10ca7bf06c959ab115'
...
INSERT INTO roles(tenant_id,role,desk_access,is_standard,modified_at)
SELECT 'alu','Thủ kho',1,0,'2026-07-29T13:29:32.534Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'341097adc3432ffac29cddc7ad229ad5bd99cc06bdf71b10ca7bf06c959ab115'
...
INSERT INTO roles(tenant_id,role,desk_access,is_standard,modified_at)
SELECT 'alu','Kế toán',1,0,'2026-07-29T13:29:32.534Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'341097adc3432ffac29cddc7ad229ad5bd99cc06bdf71b10ca7bf06c959ab115'
...
INSERT INTO roles(tenant_id,role,desk_access,is_standard,modified_at)
SELECT 'alu','Sản xuất',1,0,'2026-07-29T13:29:32.534Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'341097adc3432ffac29cddc7ad229ad5bd99cc06bdf71b10ca7bf06c959ab115'
