-- Alumdoor 1.26.2: full compiler-normalized metadata release.
...
SELECT
  ...
  0,'admin','2026-07-29T13:29:32.534Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'341097adc3432ffac29cddc7ad229ad5bd99cc06bdf71b10ca7bf06c959ab115'
  )
...
SELECT
  ...
  'admin','2026-07-29T13:29:32.534Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'341097adc3432ffac29cddc7ad229ad5bd99cc06bdf71b10ca7bf06c959ab115'
...
SELECT 'alu','Company','ALUMDOOR',0,
       '{"label":"ALUMDOOR — Cửa cuốn công nghệ Đức/Úc","abbr":"AD","default_currency":"VND","default_inventory_account":"Hàng tồn kho","default_cogs_account":"Giá vốn hàng bán"}','2026-07-29T13:29:32.534Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'341097adc3432ffac29cddc7ad229ad5bd99cc06bdf71b10ca7bf06c959ab115'
...
SELECT 'alu','Currency','VND',0,
       '{"currency_scale":0}','2026-07-29T13:29:32.534Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'341097adc3432ffac29cddc7ad229ad5bd99cc06bdf71b10ca7bf06c959ab115'
...
SELECT 'alu','UOM','Cái',0,
       '{"uom_name":"Cái","must_be_whole_number":true}','2026-07-29T13:29:32.534Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'341097adc3432ffac29cddc7ad229ad5bd99cc06bdf71b10ca7bf06c959ab115'
...
INSERT INTO master_records(tenant_id,record_type,name,disabled,data_json,modified_at)
SELECT 'alu','UOM','Bộ',0,
       '{"uom_name":"Bộ","must_be_whole_number":true}','2026-07-29T13:29:32.534Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'341097adc3432ffac29cddc7ad229ad5bd99cc06bdf71b10ca7bf06c959ab115'
...
INSERT INTO master_records(tenant_id,record_type,name,disabled,data_json,modified_at)
SELECT 'alu','UOM','Kg',0,
       '{"uom_name":"Kg"}','2026-07-29T13:29:32.534Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'341097adc3432ffac29cddc7ad229ad5bd99cc06bdf71b10ca7bf06c959ab115'
...
SELECT 'alu','UOM','Mét',0,
       '{"uom_name":"Mét"}','2026-07-29T13:29:32.534Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'341097adc3432ffac29cddc7ad229ad5bd99cc06bdf71b10ca7bf06c959ab115'
...
INSERT INTO master_records(tenant_id,record_type,name,disabled,data_json,modified_at)
SELECT 'alu','UOM','m2',0,
       '{"uom_name":"m2"}','2026-07-29T13:29:32.534Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'341097adc3432ffac29cddc7ad229ad5bd99cc06bdf71b10ca7bf06c959ab115'
...
SELECT 'alu','UOM','Cây',0,
       '{"uom_name":"Cây","must_be_whole_number":true}','2026-07-29T13:29:32.534Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'341097adc3432ffac29cddc7ad229ad5bd99cc06bdf71b10ca7bf06c959ab115'
...
SELECT 'alu','UOM','Thanh',0,
       '{"uom_name":"Thanh","must_be_whole_number":true}','2026-07-29T13:29:32.534Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'341097adc3432ffac29cddc7ad229ad5bd99cc06bdf71b10ca7bf06c959ab115'
...
SELECT 'alu','UOM','Sợi',0,
       '{"uom_name":"Sợi","must_be_whole_number":true}','2026-07-29T13:29:32.534Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'341097adc3432ffac29cddc7ad229ad5bd99cc06bdf71b10ca7bf06c959ab115'
...
SELECT 'alu','UOM','Cuộn',0,
       '{"uom_name":"Cuộn","must_be_whole_number":true}','2026-07-29T13:29:32.534Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'341097adc3432ffac29cddc7ad229ad5bd99cc06bdf71b10ca7bf06c959ab115'
...
SELECT 'alu','UOM','Tấm',0,
       '{"uom_name":"Tấm","must_be_whole_number":true}','2026-07-29T13:29:32.534Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'341097adc3432ffac29cddc7ad229ad5bd99cc06bdf71b10ca7bf06c959ab115'
...
SELECT 'alu','UOM','Túi',0,
       '{"uom_name":"Túi","must_be_whole_number":true}','2026-07-29T13:29:32.534Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'341097adc3432ffac29cddc7ad229ad5bd99cc06bdf71b10ca7bf06c959ab115'
...
SELECT 'alu','UOM','Hộp',0,
       '{"uom_name":"Hộp","must_be_whole_number":true}','2026-07-29T13:29:32.534Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'341097adc3432ffac29cddc7ad229ad5bd99cc06bdf71b10ca7bf06c959ab115'
...
SELECT 'alu','UOM','Bình',0,
       '{"uom_name":"Bình","must_be_whole_number":true}','2026-07-29T13:29:32.534Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'341097adc3432ffac29cddc7ad229ad5bd99cc06bdf71b10ca7bf06c959ab115'
...
SELECT 'alu','UOM','Lít',0,
       '{"uom_name":"Lít"}','2026-07-29T13:29:32.534Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'341097adc3432ffac29cddc7ad229ad5bd99cc06bdf71b10ca7bf06c959ab115'
...
SELECT 'alu','Item Group','Tất cả mặt hàng',0,
       '{"item_group_name":"Tất cả mặt hàng","is_group":true}','2026-07-29T13:29:32.534Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'341097adc3432ffac29cddc7ad229ad5bd99cc06bdf71b10ca7bf06c959ab115'
...
SELECT 'alu','Item Group','Thành phẩm',0,
       '{"item_group_name":"Thành phẩm","parent_item_group":"Tất cả mặt hàng","is_group":true}','2026-07-29T13:29:32.534Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'341097adc3432ffac29cddc7ad229ad5bd99cc06bdf71b10ca7bf06c959ab115'
...
SELECT 'alu','Item Group','Nguyên vật liệu',0,
       '{"item_group_name":"Nguyên vật liệu","parent_item_group":"Tất cả mặt hàng","is_group":true}','2026-07-29T13:29:32.534Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'341097adc3432ffac29cddc7ad229ad5bd99cc06bdf71b10ca7bf06c959ab115'
...
SELECT 'alu','Item Group','Linh kiện & thiết bị',0,
       '{"item_group_name":"Linh kiện & thiết bị","parent_item_group":"Tất cả mặt hàng","is_group":true}','2026-07-29T13:29:32.534Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'341097adc3432ffac29cddc7ad229ad5bd99cc06bdf71b10ca7bf06c959ab115'
...
SELECT 'alu','Item Group','Dịch vụ',0,
       '{"item_group_name":"Dịch vụ","parent_item_group":"Tất cả mặt hàng"}','2026-07-29T13:29:32.534Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'341097adc3432ffac29cddc7ad229ad5bd99cc06bdf71b10ca7bf06c959ab115'
...
SELECT 'alu','Item Group','Cửa cuốn',0,
       '{"item_group_name":"Cửa cuốn","parent_item_group":"Thành phẩm"}','2026-07-29T13:29:32.534Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'341097adc3432ffac29cddc7ad229ad5bd99cc06bdf71b10ca7bf06c959ab115'
...
SELECT 'alu','Item Group','Cửa nhôm kính',0,
       '{"item_group_name":"Cửa nhôm kính","parent_item_group":"Thành phẩm"}','2026-07-29T13:29:32.534Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'341097adc3432ffac29cddc7ad229ad5bd99cc06bdf71b10ca7bf06c959ab115'
...
SELECT 'alu','Item Group','Nan/lá cửa',0,
       '{"item_group_name":"Nan/lá cửa","parent_item_group":"Nguyên vật liệu"}','2026-07-29T13:29:32.534Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'341097adc3432ffac29cddc7ad229ad5bd99cc06bdf71b10ca7bf06c959ab115'
...
SELECT 'alu','Item Group','Mô tơ',0,
       '{"item_group_name":"Mô tơ","parent_item_group":"Linh kiện & thiết bị"}','2026-07-29T13:29:32.534Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'341097adc3432ffac29cddc7ad229ad5bd99cc06bdf71b10ca7bf06c959ab115'
...
SELECT 'alu','Item Group','Ray và trục',0,
       '{"item_group_name":"Ray và trục","parent_item_group":"Nguyên vật liệu"}','2026-07-29T13:29:32.534Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'341097adc3432ffac29cddc7ad229ad5bd99cc06bdf71b10ca7bf06c959ab115'
...
SELECT 'alu','Item Group','Phụ kiện',0,
       '{"item_group_name":"Phụ kiện","parent_item_group":"Linh kiện & thiết bị"}','2026-07-29T13:29:32.534Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'341097adc3432ffac29cddc7ad229ad5bd99cc06bdf71b10ca7bf06c959ab115'
...
SELECT 'alu','Item Group','Remote và điều khiển',0,
       '{"item_group_name":"Remote và điều khiển","parent_item_group":"Linh kiện & thiết bị"}','2026-07-29T13:29:32.534Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'341097adc3432ffac29cddc7ad229ad5bd99cc06bdf71b10ca7bf06c959ab115'
...
SELECT 'alu','Item Group','Bộ lưu điện',0,
       '{"item_group_name":"Bộ lưu điện","parent_item_group":"Linh kiện & thiết bị"}','2026-07-29T13:29:32.534Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'341097adc3432ffac29cddc7ad229ad5bd99cc06bdf71b10ca7bf06c959ab115'
...
SELECT 'alu','Warehouse','Kho Alumdoor',0,
       '{"warehouse_name":"Kho Alumdoor","is_group":true,"disabled":false}','2026-07-29T13:29:32.534Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'341097adc3432ffac29cddc7ad229ad5bd99cc06bdf71b10ca7bf06c959ab115'
...
SELECT 'alu','Warehouse','K36',0,
       '{"warehouse_name":"K36","parent_warehouse":"Kho Alumdoor","is_group":false,"address":"Kho vật lý K36","disabled":false}','2026-07-29T13:29:32.534Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'341097adc3432ffac29cddc7ad229ad5bd99cc06bdf71b10ca7bf06c959ab115'
...
SELECT 'alu','Warehouse','K12',0,
       '{"warehouse_name":"K12","parent_warehouse":"Kho Alumdoor","is_group":false,"address":"Kho vật lý K12","disabled":false}','2026-07-29T13:29:32.534Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'341097adc3432ffac29cddc7ad229ad5bd99cc06bdf71b10ca7bf06c959ab115'
...
SELECT 'alu','Cutting Policy','Cửa Đức — đại lý',0,
       '{"policy_name":"Cửa Đức — đại lý","customer_group":"Đại lý","item_group":"Cửa CN Đức","width_basis":"Phủ bì nhựa","cut_deduction_m":0.02,"note":"Chủ xưởng xác nhận 2026-07-29. BRD 25/7: ''Khách đại lý: kích thước pb nhựa − 0,02''."}','2026-07-29T13:29:32.534Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'341097adc3432ffac29cddc7ad229ad5bd99cc06bdf71b10ca7bf06c959ab115'
...
SELECT 'alu','Cutting Policy','Cửa Đức — khách lẻ',0,
       '{"policy_name":"Cửa Đức — khách lẻ","customer_group":"Lẻ","item_group":"Cửa CN Đức","width_basis":"Phủ bì ray","cut_deduction_m":0.08,"note":"Chủ xưởng xác nhận 2026-07-29 là 0,08 (BRD 25/7 ghi 0,06 — bản BRD cũ). Công trình và nhà thầu tính như khách lẻ."}','2026-07-29T13:29:32.534Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'341097adc3432ffac29cddc7ad229ad5bd99cc06bdf71b10ca7bf06c959ab115'
...
SELECT 'alu','Measurement Profile','Hàng thường',0,
       '{"profile_name":"Hàng thường","inventory_mode":"Hàng thường","stock_uom":"Cái"}','2026-07-29T13:29:32.534Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'341097adc3432ffac29cddc7ad229ad5bd99cc06bdf71b10ca7bf06c959ab115'
...
SELECT 'alu','Measurement Profile','Nhôm cây/lá',0,
       '{"profile_name":"Nhôm cây/lá","inventory_mode":"Nhôm cây/lá","stock_uom":"Kg","track_dimension_lot":true,"require_color":true,"require_length":true,"require_piece_qty":true}','2026-07-29T13:29:32.534Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'341097adc3432ffac29cddc7ad229ad5bd99cc06bdf71b10ca7bf06c959ab115'
...
SELECT 'alu','Measurement Profile','Tấm/Kính',0,
       '{"profile_name":"Tấm/Kính","inventory_mode":"Tấm/Kính","stock_uom":"Tấm","track_dimension_lot":true,"require_length":true,"require_width":true,"require_piece_qty":true}','2026-07-29T13:29:32.534Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'341097adc3432ffac29cddc7ad229ad5bd99cc06bdf71b10ca7bf06c959ab115'
...
SELECT 'alu','Measurement Profile','Cuộn',0,
       '{"profile_name":"Cuộn","inventory_mode":"Cuộn","stock_uom":"Kg","track_dimension_lot":true,"require_width":true}','2026-07-29T13:29:32.534Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'341097adc3432ffac29cddc7ad229ad5bd99cc06bdf71b10ca7bf06c959ab115'
...
SELECT 'alu','Measurement Profile','Lô/Serial',0,
       '{"profile_name":"Lô/Serial","inventory_mode":"Lô/Serial","stock_uom":"Cái"}','2026-07-29T13:29:32.534Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'341097adc3432ffac29cddc7ad229ad5bd99cc06bdf71b10ca7bf06c959ab115'
...
SELECT 'alu','Measurement Profile','Thành phẩm theo m2',0,
       '{"profile_name":"Thành phẩm theo m2","inventory_mode":"Thành phẩm theo m2","stock_uom":"Bộ","require_color":true,"require_length":true,"require_width":true}','2026-07-29T13:29:32.534Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'341097adc3432ffac29cddc7ad229ad5bd99cc06bdf71b10ca7bf06c959ab115'
...
SELECT 'alu','Account','Phải thu khách hàng',0,
       '{"account_type":"Receivable"}','2026-07-29T13:29:32.534Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'341097adc3432ffac29cddc7ad229ad5bd99cc06bdf71b10ca7bf06c959ab115'
...
SELECT 'alu','Account','Doanh thu bán hàng',0,
       '{"account_type":"Income"}','2026-07-29T13:29:32.534Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'341097adc3432ffac29cddc7ad229ad5bd99cc06bdf71b10ca7bf06c959ab115'
...
SELECT 'alu','Account','Giá vốn hàng bán',0,
       '{"account_type":"Expense"}','2026-07-29T13:29:32.534Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'341097adc3432ffac29cddc7ad229ad5bd99cc06bdf71b10ca7bf06c959ab115'
...
SELECT 'alu','Account','Hàng tồn kho',0,
       '{"account_type":"Asset"}','2026-07-29T13:29:32.534Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'341097adc3432ffac29cddc7ad229ad5bd99cc06bdf71b10ca7bf06c959ab115'
...
SELECT 'alu','Account','Phải trả người bán',0,
       '{"account_type":"Payable"}','2026-07-29T13:29:32.534Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'341097adc3432ffac29cddc7ad229ad5bd99cc06bdf71b10ca7bf06c959ab115'
...
SELECT 'alu','Account','Hàng nhận chưa có hoá đơn',0,
       '{"account_type":"Liability"}','2026-07-29T13:29:32.534Z'
WHERE EXISTS (
    SELECT 1 FROM installed_apps
    WHERE tenant_id='alu' AND app_id='alumdoor'
      AND content_hash<>'341097adc3432ffac29cddc7ad229ad5bd99cc06bdf71b10ca7bf06c959ab115'
...
SET manifest_json=json_set(manifest_json,'$.doctypes',json('[]')),
    modified_at='2026-07-29T13:29:32.534Z'
WHERE tenant_id='alu' AND app_id='alumdoor'
  AND content_hash<>'341097adc3432ffac29cddc7ad229ad5bd99cc06bdf71b10ca7bf06c959ab115';
