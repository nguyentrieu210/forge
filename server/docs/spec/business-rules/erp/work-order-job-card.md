# Work Order & Job Card — Business Rule Ledger

## 1. Scope

Contract bắt buộc cho CloudForge parity unit **Work Order & Job Card**. Exact field/schema/source path được gắn bởi source manifest; ledger này khóa hành vi không được tự suy diễn lại.

## 2. Invariants

1. Work Order required/produced quantities track transferred, completed, scrap and process loss.
2. Job Card operation sequence, workstation/time logs and pending quantity remain consistent.
3. Material transfer/consumption/manufacture entries reference work order.
4. Completion cannot exceed allowed quantity/tolerance.

## 3. Lifecycle

- Not Started → In Process → Completed/Stopped/Cancelled as derived.
- Partial finish remains supported.
