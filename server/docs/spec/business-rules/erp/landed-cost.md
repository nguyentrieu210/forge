# Landed Cost Voucher — Business Rule Ledger

## 1. Scope

Contract bắt buộc cho CloudForge parity unit **Landed Cost Voucher**. Exact field/schema/source path được gắn bởi source manifest; ledger này khóa hành vi không được tự suy diễn lại.

## 2. Invariants

1. Additional costs allocate only to eligible receipt items by configured basis.
2. Revaluation updates stock value and GL under perpetual inventory.
3. Cancellation reverses revaluation; no mutation of original SLE.
