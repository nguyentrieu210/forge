# Asset Lifecycle — Business Rule Ledger

## 1. Scope

Contract bắt buộc cho CloudForge parity unit **Asset Lifecycle**. Exact field/schema/source path được gắn bởi source manifest; ledger này khóa hành vi không được tự suy diễn lại.

## 2. Invariants

1. Capitalization establishes gross value, available-for-use date and finance book schedule.
2. Depreciation schedule uses method/frequency/shift/precision rules.
3. Movement, repair, value adjustment, sale and scrap preserve custody and GL.
4. Submitted depreciation cannot be silently recomputed without controlled regeneration.

## 3. Lifecycle

- Draft/Submitted/Disposed/Scrapped with linked accounting entries.
