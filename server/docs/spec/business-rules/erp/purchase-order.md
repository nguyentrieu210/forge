# Purchase Order — Business Rule Ledger

## 1. Scope

Contract bắt buộc cho CloudForge parity unit **Purchase Order**. Exact field/schema/source path được gắn bởi source manifest; ledger này khóa hành vi không được tự suy diễn lại.

## 2. Invariants

1. Supplier, schedule dates, item UOM and taxes validate before submit.
2. Received and billed percentages are independent.
3. Subcontracting/material-supplied flows preserve source references.
4. Close/hold rules respect downstream receipts/invoices.
