# CRM Lead — Business Rule Ledger

## 1. Scope

Contract bắt buộc cho CloudForge parity unit **CRM Lead**. Exact field/schema/source path được gắn bởi source manifest; ledger này khóa hành vi không được tự suy diễn lại.

## 2. Invariants

1. Lead source/status/owner and contact data follow duplicate and normalization policy.
2. Conversion does not delete source; creates linked organization/contact/deal as configured.
3. Assignment and communication timeline are auditable.

## 3. Lifecycle

- New → Open → Qualified/Unqualified/Converted.
