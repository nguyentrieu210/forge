# Attendance, Shift & Auto Attendance — Business Rule Ledger

## 1. Scope

Contract bắt buộc cho CloudForge parity unit **Attendance, Shift & Auto Attendance**. Exact field/schema/source path được gắn bởi source manifest; ledger này khóa hành vi không được tự suy diễn lại.

## 2. Invariants

1. One effective attendance per employee/date under source exceptions.
2. Shift assignment/default shift resolves from employee and date.
3. Check-in/out pairing, grace, late/early, holiday and overnight shift rules are deterministic.
4. Auto attendance rerun is idempotent and does not duplicate records.

## 3. Lifecycle

- Raw check-ins immutable; derived attendance may be regenerated with audit.
