# Salary Slip — Business Rule Ledger

## 1. Scope

Contract bắt buộc cho CloudForge parity unit **Salary Slip**. Exact field/schema/source path được gắn bởi source manifest; ledger này khóa hành vi không được tự suy diễn lại.

## 2. Invariants

1. Working days, payment days, leave without pay, additional salary and timesheet inputs are deterministic.
2. Component formulas/tax/proration/rounding evaluate in dependency order.
3. Net pay = gross - deductions under precision rules.
4. Submitted slip is immutable except explicit cancel/amend.
...
- `salary_slip.submitted`
- `payroll_liability.updated`
