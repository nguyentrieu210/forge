...
import { D1MutationStore, DocumentKernel } from "../../../packages/document-kernel/src/index.js";
...
export class AggregateCoordinator extends DurableObject<TenantEnv> {
  ...
  constructor(ctx: DurableObjectState, env: TenantEnv) {
    ...
    this.kernel = new DocumentKernel(registry, new D1MutationStore(env.DB), new MetadataPermissionService(metadata, undefined, new D1DocumentAccessStore(env.DB)));
  }
