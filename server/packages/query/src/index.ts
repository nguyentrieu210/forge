...
const DEFINITIONS: Record<string, ReportDefinition> = {
  ...
  "Stock Ledger": {
    ...
    allowedFilters: ["posting_at","voucher_type","voucher_no","item_code","warehouse","batch_no","serial_no"],
    defaultOrder: [{ field: "posting_at", direction: "asc" }, { field: "voucher_no", direction: "asc" }], maxRows: 5000, preparedThreshold: 1000,
  },
  "Batch Stock Balance": {
    ...
    allowedFilters: ["item_code","warehouse","batch_no","actual_qty","stock_value"],
