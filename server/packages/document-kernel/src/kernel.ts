...
export class DocumentKernel {
   ...
   * or writing the document/ledgers. This is intentionally stricter than a UI-side
   * calculator: permission, lifecycle, optimistic versioning and controller business
