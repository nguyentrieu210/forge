...
/**
 * Structural PO-vs-quotation check. It rejects stale/wrong quote references, unquoted items and
 * order quantities above the quoted quantity. Price differences are returned as variance facts;
 * approval/hold policy belongs to the later procurement/finance variance contract.
 */
