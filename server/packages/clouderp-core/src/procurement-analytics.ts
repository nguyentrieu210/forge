...
/**
 * Price history uses submitted Purchase Orders, not unselected quotations. Each observation keeps
 * both transaction-currency and company-currency rate so history remains comparable across FX.
 */
...
/** Submitted PO spend in company currency; drafts/cancelled documents are excluded. */
