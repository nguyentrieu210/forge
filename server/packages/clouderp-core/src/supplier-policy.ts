...
/**
 * Optional approved-supplier enforcement for rolling adoption.
 * Existing suppliers without procurement_status keep legacy behavior; once a tenant declares
 * procurement_status, the server fails closed unless the supplier is Approved and in-date.
 */
...
/** Weighted rating with exact basis-point arithmetic; weights must total 100%. */
...
/** Pure blanket-release ceiling evaluator. Persisted contract/release lifecycle is a later slice. */
