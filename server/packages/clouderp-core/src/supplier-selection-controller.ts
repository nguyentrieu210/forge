...
/**
 * Auditable award of ONE complete Supplier Quotation for an RFQ.
 * The comparison engine can already evaluate line-split awards, but this persisted v1 intentionally
 * chooses one complete quotation so the generic form stays deterministic without a custom action UI.
 */
