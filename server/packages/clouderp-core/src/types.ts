...
export interface JournalEntryLine extends JsonObject {
  ...
  party_type?: string;
  party?: string;
  /** Base/company-currency amount posted to GL. */
  debit: DecimalInput;
  credit: DecimalInput;
  debit_minor?: number;
  credit_minor?: number;
  /** Server-derived account currency; blank Account.account_currency means company currency. */
  ...
  /** Original immutable amount in the account currency. */
