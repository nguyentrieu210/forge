...
/**
 * Submitted qualification documents are authoritative when present. If none exist for a supplier
 * and company, the caller may fall back to legacy Supplier master approval fields.
 */
