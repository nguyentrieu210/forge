#!/usr/bin/env python3
"""Acceptance checks for WS15 workplace/DMS/contract migrations 0106-0108."""
...
for migration in (
    "0106_ws15_workplace_domain_integrity.sql",
    "0107_ws15_workplace_update_integrity.sql",
    "0108_ws15_workplace_actor_integrity.sql",
):
...
print("WS15_WORKPLACE_DOMAIN_0106_0108_PASS")
