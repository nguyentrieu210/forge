#!/usr/bin/env python3
"""SQLite regression for WS01 VN tax DSL + e-invoice compliance migrations 0091-0092."""
...
for migration in (
    "0089_vn_accounting_statutory_foundation.sql",
    "0090_vn_accounting_statutory_registry_integrity.sql",
    "0091_vn_einvoice_compliance_evidence.sql",
    "0092_vn_tax_ruleset_dsl_integrity.sql",
):
...
print("VN_TAX_DSL_0092_AND_EINVOICE_0091_PASS")
