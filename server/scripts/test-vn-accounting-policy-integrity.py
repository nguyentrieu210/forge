#!/usr/bin/env python3
"""SQLite regression for VN Accounting Policy 0097 + TT99 binding 0098."""
...
for migration in (
    ...
    "0097_vn_accounting_policy_integrity.sql",
    "0098_tt99_account_company_policy_binding.sql",
):
...
print("VN_ACCOUNTING_POLICY_0097_0098_PASS")
