#!/usr/bin/env python3
"""SQLite regression for WS01 VN statutory foundation migration 0089."""
...
db.executescript((root / "migrations/tenant/0089_vn_accounting_statutory_foundation.sql").read_text(encoding="utf-8"))
...
print("VN_ACCOUNTING_STATUTORY_FOUNDATION_0089_PASS")
