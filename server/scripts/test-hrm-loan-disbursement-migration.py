#!/usr/bin/env python3
"""Focused SQLite regression for HRM loan-disbursement migration 0048."""
import json
import sqlite3
...
db.executescript((root / "migrations/tenant/0048_hrm_loan_disbursement_integrity.sql").read_text(encoding="utf-8"))
