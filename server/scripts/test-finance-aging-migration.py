...
expect_integrity(
    db,
    insert_sql,
    base + (payload(customer="CUST-1", company="Demo", currency="VND", posting_at="2026-07-01", debit_to="131"),),
    "INVOICE_DUE_DATE_REQUIRED",
)
expect_integrity(
    db,
    insert_sql,
    base[:-3] + ("2026-07-01", "2026-07-01", payload(customer="CUST-1", company="Demo", currency="VND", posting_at="2026-07-01", due_date="2026-02-31", debit_to="131")),
    "INVOICE_DUE_DATE_INVALID",
)
expect_integrity(
    db,
    insert_sql,
    base[:-3] + ("2026-07-01", "2026-07-01", payload(customer="CUST-1", company="Demo", currency="VND", posting_at="2026-07-01", due_date="2026-06-30", debit_to="131")),
