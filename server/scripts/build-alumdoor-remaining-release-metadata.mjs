#!/usr/bin/env node
/**
 * Builds a bounded D1 metadata release equivalent to installing alumdoor@1.19.0.
 *
...
if (manifest.id !== "alumdoor" || manifest.version !== "1.19.0") {
  throw new Error(`Expected alumdoor@1.19.0, received ${manifest.id}@${manifest.version}`);
}
