#!/usr/bin/env python3
"""Focused SQLite regression for HRM lifecycle closure migration 0101."""
import json
import sqlite3
...
db.executescript((root / "migrations/tenant/0101_hrm_lifecycle_closure_integrity.sql").read_text(encoding="utf-8"))
