...
brief.prints.push({
  ...
  css: [
    ...
    ".tagline{color:#f15a24;font-size:8.2px;font-style:normal;font-weight:800;text-decoration:underline;white-space:nowrap}.ws{display:inline-block;width:2.4px}.title .ws{width:5px}.sign .ws{width:2.4px}",
