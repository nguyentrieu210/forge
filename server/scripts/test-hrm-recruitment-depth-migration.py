#!/usr/bin/env python3
"""Focused SQLite regression for HRM recruitment depth migration 0046."""
import json
import sqlite3
...
db.executescript((root / "migrations/tenant/0046_hrm_recruitment_depth_integrity.sql").read_text(encoding="utf-8"))
