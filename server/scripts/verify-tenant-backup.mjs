 ...
 *
 * `doctype_definitions` deliberately allows the reserved provisioning catalog
 * namespaces declared by the shared backup tenant-scope policy. Any other foreign
