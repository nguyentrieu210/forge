#!/usr/bin/env python3
"""Acceptance checks for WS15 evidence-backed OCR/signature states (0053)."""
...
db.executescript((root / "migrations/tenant/0053_ws15_evidence_state_integrity.sql").read_text(encoding="utf-8"))
...
print("WS15_EVIDENCE_STATE_0053_PASS")
