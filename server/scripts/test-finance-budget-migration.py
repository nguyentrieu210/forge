#!/usr/bin/env python3
"""SQLite regression for Finance Budget migrations 0093-0095."""
...
for migration in (
    "0093_finance_budget_commitment.sql",
    "0094_finance_budget_submission_closure.sql",
    "0095_finance_budget_permission_alignment.sql",
):
...
print("FINANCE_BUDGET_0093_0095_PASS")
