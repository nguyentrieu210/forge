#!/usr/bin/env python3
"""Focused SQLite regression for HRM workforce/finance integrity migration 0100."""
...
db.executescript((root / "migrations/tenant/0100_hrm_workforce_finance_integrity.sql").read_text(encoding="utf-8"))
