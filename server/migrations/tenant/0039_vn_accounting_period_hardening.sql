-- Harden Vietnamese accounting-period integrity after migration 0035.
--
...
-- Protect the ORIGINAL submitted scope. This is what closes the 1 -> 2 cancel
-- bypass and also prevents moving an already-posted document out of a locked
-- period by changing its company/date in the same update.
