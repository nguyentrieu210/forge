 ...
 * Dashboard giao hàng NCC đọc allocation timeline authoritative; đối soát gọi đúng Purchase
 * Settlement controller hiện hữu, không tạo ledger cạnh tranh. Mọi route khác delegate nguyên vẹn.
 */
export default {
