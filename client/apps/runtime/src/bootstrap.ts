...
function shouldTryWebsite(): boolean {
  ...
  // An explicit installed-app selector always wins. All other public routing is resolved
  // from the generic Website contract instead of app ids, vertical names or hostnames.
