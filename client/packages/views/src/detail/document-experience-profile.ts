...
const PROFILES: Record<DocumentArchetype, DocumentExperienceProfile> = {
  ...
  transaction: {
    ...
    heroClass: "bg-gradient-to-r from-blue-500/[0.07] via-card/95 to-card/95",
    iconClass: "bg-blue-500/10 text-blue-700 ring-blue-500/20 dark:text-blue-300",
    metricClass: "border-blue-500/15 bg-blue-500/[0.04]",
